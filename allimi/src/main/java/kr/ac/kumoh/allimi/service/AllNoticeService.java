...
//  }
//
//  public AllNoticeResponse getDetail(Long allNoticeId) {
//    AllNotice allNotice = allNoticeRepository.findById(allNoticeId)
//            .orElseThrow(() -> new AllNoticeException("해당 공지사항 찾기 실패"));
//    User user = allNotice.getUser();
//
//    List<Image> imageList = imageRepository.findAllByAllNotice(allNotice).orElse(new ArrayList<>());
...
//            .allnotice_id(allNotice.getAllNoticeId())
//            .user_id(user.getUserId())
//            .create_date(allNotice.getCreateDate())
//            .title(allNotice.getTitle())
//            .content(allNotice.getContents())
//            .important(allNotice.isImportant())
//            .image_url(imgUrls).build();
//
//  }
//
////  // 전체공지 상세보기
